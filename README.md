...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://vitaliy-stackbit.ngrok.io/pull/6089c8e2f363645b43db6fb5
...
To start editing your site, you can use the Sanity interface at https://mighty-cedar-sanity-gatsby-9c8e2.sanity.studio/.
...
Generated at `2021-04-28T20:44:02.096Z` by Stackbit version `0.3.51-staging.0`.